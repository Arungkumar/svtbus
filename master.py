...
def today(message):
    ...
    if (
        (message.chat.id == 218393491)
        or (message.chat.id == 1789180525)
        or (message.chat.id == 848403953)
    ):
        session_check()
        today = date.today()
        ...
        try:
            ...
            print("Today's seat availability\n")
...
def tomorrow(message):
    ...
    if (
        ...
        tomorrow = (
            str(tomorrow.day) + "/" + str(tomorrow.month) + "/" + str(tomorrow.year)
        )
        ...
        try:
            ...
            print("Tomorrow's seat availability\n")
            bot.reply_to(message, response)
        except:
            print("\n")
